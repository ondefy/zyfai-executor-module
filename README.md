...
# Upgrade Module
TARGET_REGISTRY_ADDRESS=0xFEe351d2Bf326AAfF9d4621c8BB2Ab7b2fe8780c forge script script/2-UpgradeAndUpdateModule.s.sol --rpc-url https://base-mainnet.g.alchemy.com/v2/key --private-key PRIVATE-KEY --broadcast -vvvv

# Verify New Impl of Module
forge verify-contract 0x266868b1Ba992cAa8aAcf7a495A7D0Fce53B5f1C src/module/GuardedExecModuleUpgradeable.sol:GuardedExecModuleUpgradeable --rpc-url https://base-mainnet.g.alchemy.com/v2/key --chain-id 8453 --compiler-version 0.8.30 --etherscan-api-key etherscan-key-add-here
