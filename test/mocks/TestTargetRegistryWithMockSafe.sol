 ...
 * @author ZyFAI
 * @notice Test registry contract that uses mock Safe wallet for testing purposes - NOT for
 * production use
 * @dev Extends TargetRegistry and overrides _isAuthorizedRecipient to use
 * MockSafeWallet.getOwners()
 *      instead of the ISafeWallet interface. Used in tests to verify ERC20 transfer authorization
 * logic.
 */
